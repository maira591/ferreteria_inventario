...
namespace Core.Application.Website.Controllers
{
    ...
    public class OmnicanalCooperativeRequestController : Controller
    {
        ...
        #region Constructor
        public OmnicanalCooperativeRequestController(IPucSolidariaService pucFinancieraService, IMapper mapper, IUserBasicModel userBasicModel, ICatalogService catalogService)
        {
        ...
        {
            ViewBag.TitleModal = "Crear Solicitud";
